...
function hoot_woo_register_sidebars() {
	hybrid_register_sidebar(
		array(
			...
			'name'        => _x( 'Woocommerce Primary Sidebar', 'sidebar', 'divogue' ),
			'description' => __( 'The primary sidebar for woocommerce pages.', 'divogue' )
		)
	);
	hybrid_register_sidebar(
		array(
			'id'          => 'hoot-woocommerce-sidebar-secondary',
			'name'        => _x( 'Woocommerce Secondary Sidebar', 'sidebar', 'divogue' ),
			'description' => __( 'The secondary sidebar for woocommerce pages (if you are using a 3 column layout with 2 sidebars).', 'divogue' )
		)
	);
}
