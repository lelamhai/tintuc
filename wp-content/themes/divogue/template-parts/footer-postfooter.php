...
if ( !empty( $site_info ) ) :
?>
	<div <?php hybridextend_attr( 'post-footer', '', 'grid-stretch highlight-typo linkstyle' ); ?>>
		<div class="grid">
				...
				<p class="credit small">
					...
					if ( trim( $site_info ) == '<!--default-->' ) {
						printf(
							...
							__( 'Designed using %1$s. Powered by %2$s.', 'divogue' ),
							hybridextend_get_wp_theme_link( 'https://wordpress.org/themes/divogue/' ),
							hybrid_get_wp_link(),
