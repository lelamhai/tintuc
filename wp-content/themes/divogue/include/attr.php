...
add_filter( 'hybrid_attr_header', 'hoot_theme_attr_header_tablemenu', 10, 2 );
 ...
 * @return array
 */
function hoot_theme_attr_header_tablemenu( $attr, $context ) {
...
function hoot_theme_attr_main( $attr ) {
	...
	// Set site layout class
	$site_layout = hoot_get_mod( 'site_layout' );
	$attr['class'] .= ( $site_layout == 'boxed' ) ? ' grid' : '';
	$attr['class'] .= ' main';
...
function hoot_theme_attr_content_block_img( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['alt'] = __( 'Content Image', 'divogue' );
	$attr['itemprop'] = 'image';
	return $attr;
}
