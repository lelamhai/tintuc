	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Hoot_Premium_Customize_Section_Pro(
				...
				'hoot_premium',
				array(
					'title'    => esc_html__( 'Divogue Premium', 'divogue' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Premium', 'divogue' ),
					'pro_url'  => esc_url( admin_url('themes.php?page=divogue-premium') ),
					'demo'     => 'http://demo.wphoot.com/divogue/',
					'docs'     => 'http://wphoot.com/support/',
					'rating'   => 'https://wordpress.org/support/view/theme-reviews/divogue#postform',
				)
			)
		);
	}
