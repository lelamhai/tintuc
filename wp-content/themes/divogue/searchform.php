...
$searchlabel = apply_filters( 'hoot_search_form_label', __( 'Search', 'divogue' ) );
$searchplaceholder = apply_filters( 'hoot_search_form_placeholder', __( 'Type Search Term...', 'divogue' ) );
$searchsubmit = apply_filters( 'hoot_search_form_submit', __( 'Search', 'divogue' ) );
